    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div id="messages_div" class="card mx-2 my-2 bg-light overflow-auto" style="max-height: 600px; min-height: 50px;" >
                <div :class="{'card mx-2 my-2 col-md-5 p-2 message rounded align-self-end bg-green': message.user.id == userId, 'card mx-2 my-2 col-md-5 p-2 message rounded': message.user.id != userId }" v-for="message in messages" :key="message.id">
